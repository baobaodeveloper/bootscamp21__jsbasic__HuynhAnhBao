...
btnPrev.addEventListener("click", () => {
  ...
  if (
    ...
    return (dateText.value = "Invalid");
  datePrev = dateValue - 1;
  monthPrev = monthValue;
  yearPrev = yearValue;
  ...
  if (dateValue === 1 && monthValue === 1) {
    datePrev = 31;
    monthPrev = 12;
    yearPrev = yearValue - 1;
  }
  ...
  if (dateValue === 1 && yearValue % 4 === 0 && monthValue === 3) {
    datePrev = 29;
    monthPrev = monthValue - 1;
    yearPrev = yearValue;
  } else if (monthValue === 3 && yearValue % 4 !== 0 && dateValue === 1) {
    datePrev = 28;
    monthPrev = monthValue - 1;
    yearPrev = yearValue;
  }

  dayPrev = `${datePrev < 10 ? "0" + datePrev : datePrev} - ${
    monthPrev < 10 ? "0" + monthPrev : monthPrev
  } - ${yearPrev}`;

  dateText.value = dayPrev;
});
